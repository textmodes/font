...
var (
	// Codepage4378x14 IBM Code Page 437
	Codepage4378x14 = &font.Bitmap{
		Data:        codepage4378x14,
		Size:        image.Point{8, 14},
		Advance:     9,
		Alpha:       color.Alpha{0xff},
		CodePoint:   codepage4378x14CodePoint,
		Encoding:    "cp437",
		Replacement: '?',
	}
	codepage4378x14 = []uint16{
